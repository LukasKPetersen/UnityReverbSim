...
public class audioplugin_SpatiotemporalReverbGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_SpatiotemporalReverb"; } }
    public override string Description    { get { return "SpatiotemporalReverb"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("audioplugin_SpatiotemporalReverb")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_SpatiotemporalReverb")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_SpatiotemporalReverb")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_SpatiotemporalReverb")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_SpatiotemporalReverb")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_SpatiotemporalReverb")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_SpatiotemporalReverb")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
